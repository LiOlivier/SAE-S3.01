    ...
    <div class="cards">
        ...
        <div class="table-wrapper">
            <table>
                <thead>
                    <tr>
                        <th class="sortable" onclick="sortTable('nom')">Nom <?php echo $sortColumn == 'nom' ? ($sortOrder == 'ASC' ? '↑' : '↓') : ''; ?></th>
                        <th class="sortable" onclick="sortTable('prenom')">Prénom <?php echo $sortColumn == 'prenom' ? ($sortOrder == 'ASC' ? '↑' : '↓') : ''; ?></th>
                        <th class="sortable" onclick="sortTable('email')">Email <?php echo $sortColumn == 'email' ? ($sortOrder == 'ASC' ? '↑' : '↓') : ''; ?></th>
                        <th class="sortable" onclick="sortTable('telephone')">Téléphone <?php echo $sortColumn == 'telephone' ? ($sortOrder == 'ASC' ? '↑' : '↓') : ''; ?></th>
                    </tr>
                </thead>
                <tbody id="table-body">
