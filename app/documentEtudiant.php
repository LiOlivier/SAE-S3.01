    ...
    try {
        ...
        if ($student) {
            ...
            echo '<div class="document-section">
                    ...
                    <p>État actuel : <span class="bordereau-etat"><?php echo htmlspecialchars($student["BordereauEtat"]); ?></span></p>
                    ...
                    <form action="./component/upload_handler.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="studentId" value="<?php echo htmlspecialchars($studentId); ?>">
                        <input type="hidden" name="documentType" value="convention">
