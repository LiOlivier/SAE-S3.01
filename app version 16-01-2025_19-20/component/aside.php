<aside class="sidenav">
    ...
    <nav>
        ...
        <ul class="aside-ul">
            ...
            <li>
                <a href="communication.php" class="bouton-side" id="Profil">
                    <div class="content-side">
                        <i class="fas fa-users" style="font-size: 1.3em;"></i><span>Communication</span>
                    </div>
                </a>
            </li>

            <li>
                <a href="notifications.php" class="bouton-side" id="Notif">
                    <div class="content-side">
                        <i class="fas fa-bell" style="font-size: 1.3em;"></i><span>Notifications</span>
                    </div>
                </a>
            </li>
            
            <li>
                <a href="reports.php" class="bouton-side" id="Profil">
                    <div class="content-side">
                        <i class="fas fa-users" style="font-size: 1.3em;"></i><span>Rapports</span>
                    </div>
                </a>
            </li>
            
            <li>
                <a href="assign-tuteur.php" class="bouton-side" id="Profil">
                    <div class="content-side">
                        <i class="fas fa-users" style="font-size: 1.3em;"></i><span>Assignation-Tuteur</span>
                    </div>
                </a>
            </li>
            ...
            <li>
                <a href="student-details.php" class="bouton-side" id="Profil">
                    <div class="content-side">
                        <i class="fas fa-users" style="font-size: 1.3em;"></i><span>Student-details</span>
                    </div>
                </a>
            </li>
