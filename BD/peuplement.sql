...
INSERT INTO `etudiant`(`Id_Etudiant`) VALUES (1), (2), (3), (4), (5), (6), (7);
...
Id_Tuteur_Entreprise,Id_Enseignant_2) VALUES
  (2024, 1, 4, 1, '2024-04-01', '2024-06-30', 'Développement d’une application web', '2024-07-15', 'Salle A1', 7, 7, 7),
  (2024, 1, 4, 2, '2024-05-01', '2024-07-31', 'Analyse des données clients', '2024-08-20', 'Salle B2', 7, 8, 7);
...
INSERT INTO Action(annee,Id_Departement,numSemestre,Id_Etudiant,Id_Stage,date_realisation,lienDocument,Id_TypeAction,Id) VALUES
  (2024, 1, 4, 1, 1, '2024-04-05', 'lien_rapport_1.pdf', 1, 5),
  (2024, 1, 4, 1, 1, '2024-05-15', NULL, 2, 7),
  (2024, 1, 4, 2, 2, '2024-05-10', 'lien_rapport_2.pdf', 1, 6),
  (2024, 1, 4, 2, 2, '2024-05-20', NULL, 2, 7);