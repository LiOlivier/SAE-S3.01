...
CREATE TABLE Tuteur_Entreprise(
    Id_Tuteur_Entreprise INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Stage(
    ...
    PRIMARY KEY(Id_Stage),  -- Clé primaire uniquement pour Id_Stage
    UNIQUE(annee, Id_Departement, numSemestre, Id_Etudiant),  -- Assurez-vous de l'unicité de cette combinaison
...
CREATE TABLE Action(
    ...
    Id INT NOT NULL,
    PRIMARY KEY(Id_Action),  -- Clé primaire uniquement pour Id_Action
    UNIQUE(annee, Id_Departement, numSemestre, Id_Etudiant, Id_Stage),  -- Assurez-vous de l'unicité de cette combinaison
